...
void BatteryNotifier::prepareNotification()
{
    ...
    if (newState.state == StateDischarging) {
        ...
        if (newState.level == BatteryLow) {
            ...
            sendNotification(NotificationLowBattery);
        } else if (newState.level == BatteryEmpty) {
            sendNotification(NotificationRechargeBattery);
        } else if (newState.level != lastState.level) {
            stopLowBatteryNotifier();
    ...
    if (newState.charger != lastState.charger) {
        ...
        } else if (lastState.charger == ChargerNo
                   && newState.state == StateDischarging) {
